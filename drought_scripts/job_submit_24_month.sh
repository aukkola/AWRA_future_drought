...
cd /g/data/w97/amu561/Steven_CABLE_runs/scripts/drought_scripts
    ...
    for model in CSIRO-BOM-ACCESS1-0 CNRM-CERFACS-CNRM-CM5 NOAA-GFDL-GFDL-ESM2M MIROC-MIROC5; do
        ...
        for scenario in rcp45 rcp85; do
            ...
            for variable in qtot s0 pr; do
		            ...
		            outdir="/g/data/w97/amu561/Steven_CABLE_runs/drought_metrics/${scale}-month/${bcm}/${model}/"  
                mkdir -p $outdir
		            out_file=/g/data/w97/amu561/Steven_CABLE_runs/drought_metrics/${scale}-month/${bcm}/${model}/drought_metrics_${bcm}_${model}_${variable}_${scenario}_${scale}.nc 
                     
                if [ ! -f ${out_file} ]; then

                echo job_${bcm}_${model}_${scenario}_${variable}
                cp job_template_${scale}.sh ${PBS_PATH}/job_${bcm}_${model}_${scenario}_${variable}.sh
                wait
