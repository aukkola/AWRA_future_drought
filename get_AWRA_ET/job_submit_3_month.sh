...
PBS_PATH=/g/data/oq98/amu561/Steven_CABLE_runs/scripts/get_AWRA_ET/pbs_jobs

mkdir -p ${PBS_PATH}

cd /g/data/oq98/amu561/Steven_CABLE_runs/scripts/get_AWRA_ET/
...
for bcm in QME MRNBC CCAM ISIMIP2b; do
    ...
    for model in CSIRO-BOM-ACCESS1-0 CNRM-CERFACS-CNRM-CM5 NOAA-GFDL-GFDL-ESM2M MIROC-MIROC5; do
        ...
        for scenario in rcp45 rcp85; do
            ...
            for variable in etot qtot pr; do
                              
		            outdir="/g/data/w97/amu561/Steven_CABLE_runs/AWRA_ET/3-month/${bcm}/${model}/"  
                mkdir -p $outdir
		            #out_file=/g/data/w97/amu561/Steven_CABLE_runs/AWRA_ET/3-month/${bcm}/${model}/AWRA_total_ET_${bcm}_${model}_${variable}_${scenario}_3.nc 
